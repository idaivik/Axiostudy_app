...
enum ClassLevel {
  ...
  /// The value stored in `chapters.class_level`.
  String get dbValue => this == ClassLevel.class11 ? 'class11' : 'class12';
}
...
/// Resolve a chapter's class from the DB `class_level` value, falling back to
/// the legacy id-derived mapping when the column is null (older rows / safety).
ClassLevel classLevelFromDb(String? value, String chapterId) {
  switch (value) {
    case 'class11':
      return ClassLevel.class11;
    case 'class12':
      return ClassLevel.class12;
    default:
      return chapterClassLevel(chapterId);
  }
}
